...
//	@WebServlet("/el")	//	현재 클래스를 /el 패턴에 반응하는 서블릿으로 등록
...
public class EmaillistServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//	다른 서블릿(JSP)을 추가 작업진행
		String action = req.getParameter("a");	//	a파라미터를 확인
		
		if ("form".equals(action)) {	//	a=form이면
		//	등록 폼: 파라미터에서 a(파라미터)를 확인 form이면 분기
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String action = req.getParameter("action");	//	히든필드
